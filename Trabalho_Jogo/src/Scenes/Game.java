...
public class Game {
    ...
    public Game(Stage primaryStage) {
        ...
        questions = new Question[] {
                ...
                new Question("Qual das seguintes opções poderia ser um motivo para lançar uma exceção?",
                        new ArrayList<Option>(Arrays.asList(
                                new Option("Você tem um erro fatal no programa.", false),
                                new Option("Você encontrou um Erro de Derramamento de Pilha", false),
                                new Option("Tornar a interface do usuário mais difícil de navegar.", false),
                                new Option("Evitar que as exceções interrompam sem programa.", true)))),
    ...
    private void SetGame() {
        ...
        QuestionScene question = new QuestionScene(primaryStage, questions[0]);
        gridGame.getChildren().add(question.gridGame);


        /* QuestionScene question = new QuestionScene(primaryStage, questions[6]);
        primaryStage.setScene(question.scene); */
